...
const AnnouncementBanner = () => {
    return (
        <>
            <div class="bg-black px-6 py-3 gap-4 h-15 flex items-center justify-center">
                <div class="flex items-center justify-center text-center relative">
                    <p class="text-[15px] text-white font-medium pr-6 leading-relaxed">🎉 Limited Time Offer! Enjoy 20% OFF your first purchase –
                        <a href="javascript:void(0)" class="ml-1">Shop Now!</a></p>
                    <div class="absolute right-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 cursor-pointer fill-white inline-block" viewBox="0 0 320.591 320.591">
