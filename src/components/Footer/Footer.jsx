...
const Footer = () => {
    return (
        <footer class="bg-white dark:bg-gray-900">
            <div class="w-full space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div class="text-teal-600 dark:text-teal-300">
                           <img src="https://smartwebcarecenter.com/wp-content/uploads/2025/05/smart-website-logo-2.png" className='w-30 h-auto' alt="" />
                        </div>

                        <p class="mt-4 max-w-xs text-gray-500 dark:text-gray-400">
                            smart web care center provide best services for your website needs.
                        </p>
