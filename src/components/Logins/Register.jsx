...
const Register = () => {
    return (
        <>
            <div class="max-w-4xl max-sm:max-w-lg mx-auto pb-6 mt-6">
                    <h4 class="text-center py-5 text-slate-600 text-base mt-6">Sign up into your account</h4>
                ...
                <form>
                    ...
                    <div class="mt-12">
                        <button type="button" class="mx-auto block min-w-32 py-3 px-6 text-sm font-medium tracking-wider rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none cursor-pointer">
                         ...
                         <p class="text-[15px] mt-6 text-slate-600">Already have an account <Link to="/login" class="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">
                                                    Login here</Link></p>
                    </div>
                </form>
            </div>
