                ...
                <div class="md:max-w-md w-full px-4 py-4">
                    <form>
                        <div class="mb-12">
                            ...
                            <p class="text-[15px] mt-6 text-slate-600">Don't have an account <Link to="/register" class="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4 mt-8">
                            ...
                            <div>
                                <Link to="/forget-password" class="text-blue-600 font-medium text-sm hover:underline">
                                    Forgot Password?
                                </Link>
                            </div>
                        </div>
