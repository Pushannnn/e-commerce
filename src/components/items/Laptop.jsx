...
const Laptop = ({ onAddToCart, handleAddToCart }) => {
  // Array of laptops
  const laptops = [
    { brand: 'DELL', name: 'Dell XPS 13', price: 999.00, image: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=500&q=80' },
    { brand: 'APPLE', name: 'MacBook Pro 14"', price: 1999.00, image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=500&q=80' },
    { brand: 'HP', name: 'HP Pavilion 15', price: 749.00, image: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500&q=80' },
    { brand: 'LENOVO', name: 'ThinkPad X1 Carbon', price: 1299.00, image: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=500&q=80' },
    { brand: 'ASUS', name: 'ROG Zephyrus G14', price: 1449.00, image: 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=500&q=80' },
    { brand: 'MICROSOFT', name: 'Surface Laptop 5', price: 1299.00, image: 'https://images.unsplash.com/photo-1587614382346-4ec70e388b28?w=500&q=80' },
    { brand: 'ACER', name: 'Acer Swift 3', price: 649.00, image: 'https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=500&q=80' },
    { brand: 'RAZER', name: 'Razer Blade 15', price: 1799.00, image: 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=500&q=80' },
  ];
  ...
  const LaptopCard = ({ brand, name, price, image }) => (
    <div className="lg:w-1/4 md:w-1/2 p-4 w-full group">
      <div className="border border-gray-200 rounded-xl p-4 shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:border-blue-500 group-hover:scale-105 group-hover:bg-blue-50 relative">
        ...
        <button onClick={() => {
          onAddToCart(); handleAddToCart({ brand, name, price, image });
